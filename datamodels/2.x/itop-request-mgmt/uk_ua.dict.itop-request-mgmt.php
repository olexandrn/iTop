...
Dict::Add('uk ua', 'Ukraine', 'Українська', array(
	...
	'Class:UserRequest/Attribute:status/Value:waiting_for_approval' => 'Очікує затвердження',
	'Class:UserRequest/Attribute:status/Value:waiting_for_approval+' => '~~',
	'Class:UserRequest/Attribute:status/Value:approved' => 'Затверджений',
	...
	'Class:UserRequest/Attribute:request_type/Value:service_request+' => 'Запит на отримання інформації, або консультацію, або на стандартну зміну, доступ',
