...
Dict::Add('uk ua', 'Ukraine', 'Українська', array(
	'Class:Ticket' => 'Звернення',
	'Class:Ticket+' => '~~',
	'Class:Ticket/Attribute:ref' => 'Номер',
	'Class:Ticket/Attribute:ref+' => '~~',
	'Class:Ticket/Attribute:org_id' => 'Організація',
	'Class:Ticket/Attribute:org_id+' => '~~',
	'Class:Ticket/Attribute:org_name' => 'Організація',
	'Class:Ticket/Attribute:org_name+' => '~~',
	'Class:Ticket/Attribute:caller_id' => 'Ініціатор',
	'Class:Ticket/Attribute:caller_id+' => '~~',
	'Class:Ticket/Attribute:caller_name' => 'Ініціатор',
	'Class:Ticket/Attribute:caller_name+' => '~~',
	'Class:Ticket/Attribute:team_id' => 'Команда',
	'Class:Ticket/Attribute:team_id+' => '~~',
	'Class:Ticket/Attribute:team_name' => 'Команда',
	'Class:Ticket/Attribute:team_name+' => '~~',
	'Class:Ticket/Attribute:agent_id' => 'Виконавець',
	'Class:Ticket/Attribute:agent_id+' => '~~',
	'Class:Ticket/Attribute:agent_name' => 'Виконавець',
	'Class:Ticket/Attribute:agent_name+' => '~~',
	'Class:Ticket/Attribute:title' => 'Назва',
	'Class:Ticket/Attribute:title+' => '~~',
	'Class:Ticket/Attribute:description' => 'Опис',
	'Class:Ticket/Attribute:description+' => '~~',
	'Class:Ticket/Attribute:start_date' => 'Дата створення',
	'Class:Ticket/Attribute:start_date+' => '~~',
	'Class:Ticket/Attribute:end_date' => 'Дата виконання',
	'Class:Ticket/Attribute:end_date+' => '~~',
	'Class:Ticket/Attribute:last_update' => 'Останнє оновлення',
	'Class:Ticket/Attribute:last_update+' => '~~',
	'Class:Ticket/Attribute:close_date' => 'Дата закриття',
	'Class:Ticket/Attribute:close_date+' => '~~',
	'Class:Ticket/Attribute:private_log' => 'Внутрішній журнал',
	'Class:Ticket/Attribute:private_log+' => '~~',
	'Class:Ticket/Attribute:contacts_list' => 'Контакти',
	'Class:Ticket/Attribute:contacts_list+' => 'Пов’язані контакти',
	'Class:Ticket/Attribute:functionalcis_list' => 'КО',
	'Class:Ticket/Attribute:functionalcis_list+' => ' Усі КО, на які впливає цей тікет. Items marked as "Computed" have been automatically marked as impacted. Items marked as "Not impacted" are excluded from the impact.~~',
